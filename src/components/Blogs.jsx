...
import { Tag, Button, Flex, Tooltip } from "antd";
import {
  DoubleLeftOutlined,
  DoubleRightOutlined,
  FileSearchOutlined,
  ...
  return (
    <>
      ...
      <div className="w-full flex">
        ...
        >
          My blog delves into meaningful problem-solving approaches, learning
          new technologies and languages, with a focus on databases, big data,
          and backend frameworks. Primarily centered around Python, the posts
          offer insightful examples and discussions. These articles serve as a
          resource for those interested in innovative solutions and the
          exploration of emerging tech trends in the programming world.
        </motion.p>
      </div>
      <div className="relative mt-20 flex">
        ...
        <div
          className="mt-20 flex overflow-x-auto"
          id="scroll-container"
          constyle={{ height: "520px" }}
        >
          {" "}
          {/* 设置足够的高度 */}
          {blogs.map((blog, index) => (
            <div
              className="inline-block mr-8 last:mr-0"
              key={`project-${index}`}
            >
              {" "}
